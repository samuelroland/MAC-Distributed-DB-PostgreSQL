...
title:  |
  ...
  | \vspace{1cm} Étude des mécanismes de distribution dans PostgreSQL
  | \vspace{0.5cm}\large MAC

author: "Samuel Roland et Timothée Van Hove"
date: \today
...
header-includes:
    ...
    - \fancyhead[C]{Étude des mécanismes de distribution dans PostgreSQL}
    - \fancyhead[R]{Roland, Van Hove\\\today}
